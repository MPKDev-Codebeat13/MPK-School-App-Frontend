...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen w-full text-white bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <Header />

      {/* Hero / Welcome */}
      <section className="w-full text-center py-24 px-4 bg-gradient-radial from-purple-600 via-indigo-700 to-indigo-800 text-white shadow-xl">
      ...
      <div className="grid gap-8 max-w-[1300px] w-full my-16 px-4 md:grid-cols-3">
        {/* About */}
        <section className="p-6 rounded-2xl text-center transition-transform duration-300 transform hover:scale-105 bg-indigo-800/20 shadow-lg">
          ...
          <p className="mb-4 leading-relaxed">
            ...
            reports in seconds. Students can track progress and access resources
            anytime.
          </p>
          <p className="mb-4 leading-relaxed">
        ...
        <section className="p-6 rounded-2xl text-center transition-transform duration-300 transform hover:scale-105 bg-indigo-800/20">
          ...
          <p className="mb-4 leading-relaxed">
            Our app is intuitive, secure, and designed to make every school day
            efficient. Whether it’s lesson planning, attendance, or
