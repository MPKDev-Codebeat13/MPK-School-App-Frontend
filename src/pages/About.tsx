...
const About: React.FC = () => {
  return (
    <div className="flex flex-col items-center min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-indigo-100 font-sans">
      ...
      {/* Hero Section */}
      <section className="w-full text-center py-20 px-6 bg-gradient-to-tr from-indigo-500 to-indigo-700 rounded-2xl shadow-2xl mt-8 mx-4 md:mx-12">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-white drop-shadow-lg">
          About MYM Nexus
        </h1>
        <p className="text-lg md:text-xl leading-relaxed max-w-3xl mx-auto text-indigo-100">
      ...
      {/* Details Section */}
      <section className="max-w-4xl w-11/12 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-10 my-12 text-indigo-100">
