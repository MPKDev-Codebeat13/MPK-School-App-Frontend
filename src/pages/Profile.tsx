...
export default function Profile() {
  ...
  return (
    <div className="flex min-h-screen">
      <Sidebar />
      <div
        className={`flex justify-center items-start min-h-[calc(100vh-4rem)] p-6`}
      >
        <Card
          ...
          <CardContent className="space-y-10">
                ...
                {(() => {
                  ...
                  return profilePictureUrl ? (
                    <div className="relative">
                      ...
                      />
                      <div
                        className="w-32 h-32 rounded-full bg-violet-600 flex items-center justify-center text-white font-bold text-4xl absolute top-0 left-0"
                        style={{ display: 'none' }}
                      >
                        {getInitials(name)}
                      </div>
                    ...
                    <div className="w-32 h-32 rounded-full bg-violet-600 flex items-center justify-center text-white font-bold text-4xl">
                      {getInitials(name)}
                    </div>
                  )
                })()}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                <label className={`${textMuted} text-sm`}>Full Name</label>
                <Input
                  value={name}
              ...
              <div className="space-y-2">
                <label className={`${textMuted} text-sm`}>Email</label>
                <Input
                  value={email}
                  readOnly
                  className={`${
              ...
              <div className="space-y-2">
                <label className={`${textMuted} text-sm`}>Role</label>
                <Input
                  value={role}
                  readOnly
                  className={`${
              ...
              <div className="flex items-end gap-3">
                <Button
                  ...
                  disabled={saving}
                  className="bg-violet-600 hover:bg-violet-500 rounded-xl flex items-center gap-2 px-5"
                >
                ...
                <Button
                  variant="outline"
                  className="rounded-xl flex items-center gap-2 px-5"
                  onClick={() => {
                    setName(localUser?.name || localUser?.fullName || '')
                    setEmail(localUser?.email || '')
                    setRole(localUser?.role || '')
            ...
            <div
              className={`rounded-2xl p-5 border-2 border-red-200 ${
                isLight
